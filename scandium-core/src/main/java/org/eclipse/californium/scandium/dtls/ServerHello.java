...
public final class ServerHello extends HandshakeMessage {
	...
	//添加一个identity字段，
	// 为了告知客户端自己已经从ClientHello报文中给定的identity中选定了自己支持的
	//并且让客户端也开始生成自己的对称密钥
	...
	//重载ServerHello的构造函数，添加一个identity字段
	public ServerHello(String identity, ProtocolVersion version, Random random, SessionId sessionId,
					   CipherSuite cipherSuite, CompressionMethod compressionMethod, HelloExtensions extensions,
					   InetSocketAddress peerAddress) {
		super(peerAddress);
