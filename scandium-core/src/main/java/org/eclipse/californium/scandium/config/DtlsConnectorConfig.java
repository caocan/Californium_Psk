	...
	public static final class Builder {
		...
		private void verifyPskBasedCipherConfig() {
			if (config.pskStore == null) {
				System.out.println("DTLSConnectorConfig-->config方法-->没设置pskStore");
			...
			System.out.println("DTLSConnectorConfig-->config方法-->验证PSK");
		}

		private void verifyEcBasedCipherConfig() {
			if (!clientOnly) {
				if (config.getPrivateKey() == null || config.getPublicKey() == null) {
					System.out.println("DTLSConnectorConfig-->config方法-->没设置Identity");
			...
			System.out.println("DTLSConnectorConfig-->config方法-->验证ECC");
		}
